...
var gameModalContent = {
	doy: '<div id="doy_game" class="game_modal"><span class="close_x" onclick="hideShowModal(false)">X</span><div class="game_content"><h3 class="blue1">dreams of yesterday</h3><p>solve mysteries, explore the past and help save the future in a 3D adventure game for mac and windows.</p><p class="release_date"><b>coming in spring 2016</b></p></div><a href="" target="_blank"><div id="doy_ss" class="game_ss"></div></a></div>',
